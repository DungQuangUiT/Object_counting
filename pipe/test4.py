...
xml_path = 'pipe1.xml'  # Thay đổi đường dẫn tới file XML của bạn
...
while(cap.isOpened()):
    ...
    for window_size in window_sizes:
        for (x, y, window) in sliding_window(gray, step_size=8, window_size=window_size):
            ...
            window_resized = cv2.resize(window, (80, 36))
    ...
    if len(boxes) > 0:
        ...
        indices = non_max_suppression(boxes, scores, threshold=0.2)
    ...
    # Lưu kết quả
    cv2.imwrite("pipe1_IoU.jpg", result_image)
